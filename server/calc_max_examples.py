...
parser.add_argument('-t', type=float, required=True, help='Zeit pro Kombination mit 50 Beispielen in Sekunden (z.B. 3908)')
...
t_50 = args.t
# Formel des Users:
# n_combinations * N_VALIDATION_max * t_50 / 50 <= total_seconds
# => N_VALIDATION_max = total_seconds / (n_combinations * t_50 / 50)
N_VALIDATION_max = total_seconds / (n_combinations * t_50 / 50)
...
print(f"Zeit pro Kombination (für 50 Beispiele): {t_50:.2f} Sekunden")
